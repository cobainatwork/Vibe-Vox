...
分批的代價小：32 段（總音訊 1075 秒）只花 1.4 秒，RTF ≈ 0.0013，與 ADR-0004 記載的 0.001 相符；batch 相對逐段送約快 2.3 倍，是常數級改善而非數量級。63 段切成 32 + 31 約 2.8 秒。

**不要改為調大上限**：32 段實測峰值 5750 MiB，64 段推估 9218 MiB 已超出可用量（見上表）。
